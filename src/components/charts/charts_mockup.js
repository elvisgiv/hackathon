...
export default class ChartsMockup extends Component {
    ...
    constructor(props) {
        ...
        this.handleChangeAnotherState = this.handleChangeAnotherState.bind(this);

    }

    handleChangeData() {
        this.setState(() => _.mapValues(this.state.opacity, changeNumberOfData));
    };
