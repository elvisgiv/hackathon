...
export default class TransactionTo extends React.Component {
  render() {
    return (
      <div className="transaction fl-cont fl-center-vert padd-top-15 padd-bott-15 padd-left-10 bord-bott" key={this.props.i}>
        <div className="fl-col padd-ri-md">
          <Identicon size={40} hash={this.props.transaction.from}/>
        </div>
        <div className="fl-col fl-grow">
          <h6 className="g-6 fw-5 fs-4 inl">{this.props.transaction.from}</h6> <br/>
