...
export default class BotExchange extends React.Component {
    ...
    async getTransactions() {
        ...
        let transfers = await skale.contract('token').getTransferHistory(account);
                    ...
                    <div className="fl-cont padd-left-md">
                        ...
                        onClick={evt => this.setState({
                          ...
                          snackbarMessage: "Address copied to clipboard"
                                ...
                                <Button unelevated className="red-btn" onClick={this.toggleSendS}
                                        style={{minWidth: "135px"}}>
                                    <ButtonIcon use="call_received"/>Receive
                                    <Modal isOpen={this.state.sendModalS} toggle={this.toggleSendS}>
                                        <SendModalReceive showSnackbar={this.showSnackbar}
                                                          ToggleSend={this.toggleSendS}/>
                                    </Modal>
                                </Button>
                            </CopyToClipboard>
